...
export const SubCategoryForm: React.FC<SubCategoryFormProps> = ({
  ...
  const onSubmit = async (data: SubCategoryFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/${params.brandId}/subcategory/${params.subCategoryId}`, data);
      } else {
        await axios.post(`/api/${params.brandId}/subcategory`, data);
      }
      router.refresh();
      router.push(`/${params.brandId}/subcategory`);
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.brandId}/subcategory/${params.subCategoryId}`);
      router.refresh();
      router.push(`/${params.brandId}/subcategory`);
